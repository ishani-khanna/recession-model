...
with open("output/dashboard.html", "w") as f:
    f.write(html)
# RETIRED as the published page: the single report-matching dashboard (docs/index.html) is now
# generated by build_two_clock_data.py. This legacy generator only writes to output/ for reference.
with open("output/dashboard_legacy.html", "w") as f:
    f.write(html)
